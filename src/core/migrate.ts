...
export const MIGRATIONS: Migration[] = [
  ...
  },
  {
    ...
    sql: `
      ...
      --
      -- Use dynamic SQL for statements that reference newly-added columns.
      -- PostgreSQL parses a multi-statement query before executing the ALTER,
      -- so a plain UPDATE/CREATE INDEX in the same SQL string can fail on
      -- legacy brains with "column agent_name does not exist".
      DO $$
      BEGIN
        EXECUTE '
